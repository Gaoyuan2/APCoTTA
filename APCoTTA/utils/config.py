...
class Config:
    ...
    #Strong augmentation
    # augment_scale_anisotropic2 = True
    # augment_scale_min2 = 0.92 #0.9
    # augment_scale_max2 = 1.12 # 1.1
    # augment_symmetries2 = [False, False, False]
    # augment_rotation2 = 'vertical'
    # augment_noise2 = 0.007 #0.005
    # augment_color2 = 0.77 #0.7

    augment_scale_anisotropic2 = True
    augment_scale_min2 = 0.8 #0.9
    augment_scale_max2 = 1.2 # 1.1
    augment_symmetries2 = [False, False, False]
    augment_rotation2 = 'vertical'
    augment_noise2 = 0.01 #0.005
    augment_color2 = 0.8 #0.7
